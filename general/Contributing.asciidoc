...
=== Trivial changes
Please note that for trivial changes like a typo in the documentation you do not need to follow a complex processes. Please do the following:
...
* All documentation files need to carry the `.asciidoc` extension.
