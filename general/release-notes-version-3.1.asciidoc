...
The devonfw-shop-floor project has got a lot of updates in order to make even easier the creation of devonfw projects with CICD pipelines that run on the Production Line and deploy on Red Hat OpenShift Clusters and in general Docker environments. See the details below. 
