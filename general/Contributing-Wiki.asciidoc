...
Contributing guidelines moved https://github.com/devonfw/.github/blob/master/CONTRIBUTING.asciidoc#contributing[here]. Feel free to merge over what remains valuable from here. This document will be deleted in the future.
